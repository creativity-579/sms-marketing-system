...
export default function CampaignCreation() {
  ...
  const handleSaveDraft = async () => {
    try {
      ...
      setMessage("");
      setSelectedGroups([]);
      setSelectedSenderId("");      setScheduleDate("");
      setScheduleTime("");
    } catch (error) {
      console.log("error", error.message);
    }
  ...
  const handleUpdateCampaign = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `New Campaign has been updated successfully.`,
      });
  ...
  const handleDeleteCampaign = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Selected Campaign deleted successfully!`
      })
          ...
          <div className="space-y-6">
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-blue-50 rounded-3xl overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <Button className="hover: bg-cyan-700" onClick={handleSaveDraft}>Save as Draft</Button>
              </CardContent>
            </Card>
          </div>
        </div>
