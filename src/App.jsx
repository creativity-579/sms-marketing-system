...
import ManagementSenderIds from "./pages/admin/SenderId.jsx";
...
import CampaignMonitoring from "./pages/admin/CampaignManagement";
  ...
  return (
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/SenderIds" element={<ManagementSenderIds />}/>
          <Route path="/admin/CountryManagement" element={<CountryManagement />}/>
          ...
          <Route path="/admin/CampaignManagment" element={<CampaignMonitoring/>}/>
          <Route path="/admin/TemplateReview" element={<TemplateReview/>}/>
